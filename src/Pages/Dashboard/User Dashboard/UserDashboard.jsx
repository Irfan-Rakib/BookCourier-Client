...
const UserDashboard = () => {
  ...
  const navItems = [
    ...
    { to: "chart", label: "View User On Chart", icon: FaUser },
  ];
  ...
  return (
    <>
      ...
      <button
        ...
        className={`lg:hidden fixed top-30 left-8 z-50 p-2  backdrop-blur-md rounded-xl shadow-2xl border hover:shadow-2xl hover:bg-white hover:scale-105 transition-all duration-300 ${
          isScrolled
      ...
      {/* Mobile Overlay */}
      {isSidebarOpen && (
        <div className="lg:hidden fixed inset-0  z-40" onClick={closeSidebar} />
      )}
